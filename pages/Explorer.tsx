...
const Explorer = () => {
  ...
  async function searchContract() {
    ...
    try {
      ...
      // );
      const response =
        "https://w3s.link/ipfs/bafkreibf6htsxamcecbwk43w7hkq3g3drt5rsd7ioslnetsvzjel3gwm2a ";
      toast({
      ...
      <main className="bg-black min-h-[77.6vh]">
        ...
        <div className="mx-auto max-w-xl mb-10 px-4">
          ...
          <div className="flex justify-evenly py-10">
            <button
              className={`text-white text-lg focus:border-t-2 ${isReadActive ? "border-t-2 border-[#ed4e33]" : "none"
                }`}
              onClick={() => {
                setShowType("read");
            ...
            <button
              className={`text-white text-lg focus:border-t-2 ${isWriteActive ? "border-t-2 border-[#ed4e33]" : "none"
                }`}
              onClick={() => {
                setShowType("write");
            ...
            <button
              className={`text-white text-lg focus:border-t-2 ${isSourceCodeActive ? "border-t-2 border-[#ed4e33]" : "none"
                }`}
              onClick={() => {
                setShowType("source");
                setIsSourceCodeActive(true);
